...
class AboutLists(Koan):
    ...
    def test_list_literals(self):
        ...
        nums[3:5] = [4, 5]
        self.assertEqual([1, 2, 333, 4, 5], nums)

        nums[5:6] = [6, 7, 8]
        self.assertEqual([1, 2, 333, 4, 5, 6, 7, 8], nums)

        nums[3:5] = [444, 555]
        self.assertEqual([1, 2, 333, 444, 555, 6, 7, 8], nums)
    ...
    def test_slicing_lists(self):
        ...
        self.assertEqual(list(), noms[5:0])
    ...
    def test_popping_lists(self):
        ...
        self.assertEqual(20, popped_value, "The input to pop(i) is an index")
